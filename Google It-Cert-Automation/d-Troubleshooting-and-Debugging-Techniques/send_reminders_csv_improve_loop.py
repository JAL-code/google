...
# Older setup. Not the file is opened and not closed.
# Also the file is left open while the loop is running.
...
def send_message(date, title, emails, contacts):
    ...
    for email in emails.split(','):
        name = names[email]
        message = message_template(data, title, name)
...
def main():
    ...
    # Error is determined not to useful
